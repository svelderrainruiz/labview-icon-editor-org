...
public class RunnerCliCliTests
{
    ...
    [Fact]
    public void Vipc_assert_dry_run_with_fail_on_mismatch_false_uses_boolean_parameter_form()
    {
        var repoRoot = FindRepoRoot();
        var outputPath = Path.Combine(repoRoot, "builds", "status", "vipc-audit-64.json");
        ...
        Assert.DoesNotContain("-FailOnMismatch false", stderr, StringComparison.OrdinalIgnoreCase);
    }
